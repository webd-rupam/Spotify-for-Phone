...
async function getSongs() {
    let a = await fetch('https://webd-rupam.github.io/songs/');
    ...
    for (let index = 0; index < as.length; index++) {
        ...
        if (element.href.endsWith(".mp3")) {
            songs.push(decodeURIComponent(element.href.split("https://webd-rupam.github.io/songs/")[1]));
        }
    }
    return songs;
}
...
async function playMusic(track, pause = false) {
    let audioUrl = "https://webd-rupam.github.io/songs/" + encodeURIComponent(track);
